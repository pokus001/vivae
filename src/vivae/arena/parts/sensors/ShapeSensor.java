 ...
 * @author Petr Smejkal
 */
public class ShapeSensor extends Sensor{
    ...
    public ShapeSensor(Active owner, double angle, int number){
        this(owner, number);
        setAngle((float)angle);
    }


    public ShapeSensor(Active owner){
        super(owner);
    ...
    public ShapeSensor(Active owner, int number) {
        super(owner);
        this.owner = owner;
        this.ownerBody = owner.getBody();
        this.sensorNumber = number;
